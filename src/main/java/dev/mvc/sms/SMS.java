...
public class SMS {
  ...
  public static void main(String[] args) throws IOException {
    String smsId = "friziaesms"; // SMS ID 를 입력해 주세요.
    String accessToken = Tool.getSmsAccessToken(); // ACCESS TOKEN 을 입력해 주세요.
    String authValue =
    ...
    .addFormDataPart("phone", "01054931423") // 수신번호를 입력해 주세요. (수신번호가 두 개 이상인 경우 ',' 를 이용하여 입력합니다. ex) 01011112222,01033334444)
    .addFormDataPart("callback", "01054931423") // 발신번호를 입력해 주세요.
    .addFormDataPart("message", "TEST_FOR_GABIA") // SMS 내용을 입력해 주세요.
